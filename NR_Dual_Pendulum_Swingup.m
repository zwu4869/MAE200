...
s.B=[0; 0; 0; 1; 0; 0]; s.Q=diag([0.5 0.5 0.51 0.1 0.1 0.3]); s.R=0 ; s.QT=diag([5 41 33 3 10 2]);
...
for k=0:k_max, k
  ...
  figure(1); clf; subplot(2,1,1); plot(t,x_k(1,:),'r-',t,x_k(2,:),'b-',t,x_k(3,:),'g-',t,x_k(5,:),'y-',t,x_k(6,:),'c-');
